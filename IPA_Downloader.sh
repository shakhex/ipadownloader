...
load_lang() {
    ...
    L[ClearMenu1_RU]="1. Список приобретенных приложений"
    L[ClearMenu1_EN]="1. Purchased apps list"
    L[ClearMenu2_RU]="2. Список загруженных приложений"
    L[ClearMenu2_EN]="2. Downloaded apps list"
    L[ClearMenu3_RU]="3. Приложения в папке Apps"
    L[ClearMenu3_EN]="3. Apps in Apps folder"
    ...
    L[DownloadedListMenu1_RU]="1. Полный список приложений (GitHub)"
    L[DownloadedListMenu1_EN]="1. Full apps list (GitHub)"
    L[DownloadedListMenu2_RU]="2. Список загруженных приложений"
    L[DownloadedListMenu2_EN]="2. Downloaded apps list"
    L[DownloadedListMenu3_RU]="3. Список не загруженных приложений"
    L[DownloadedListMenu3_EN]="3. Not downloaded apps list"
    ...
    L[InstallerMenu1_RU]="1. Проверка минимальной версии iOS для приложений в папке Apps"
    L[InstallerMenu1_EN]="1. Check minimum iOS version for apps in Apps folder"
    L[InstallerMenu2_RU]="2. Установка приложений из папки Apps"
    L[InstallerMenu2_EN]="2. Install apps from Apps folder"
    L[InstallerMenu3_RU]="3. Поддержка проекта"
    L[InstallerMenu3_EN]="3. Project support"
    L[InstallerMenu4_RU]="4. Сменить язык (Change Language)"
    L[InstallerMenu4_EN]="4. Change Language (Сменить язык)"
    L[InstallerMenu5_RU]="5. Сброс настроек"
    L[InstallerMenu5_EN]="5. Reset settings"
    L[InstallerMenu6_RU]="6. Перейти в IPA_Downloader"
    L[InstallerMenu6_EN]="6. Switch to IPA_Downloader"
    ...
    L[LanguageMenu1_RU]="1. Русский"
    L[LanguageMenu1_EN]="1. Русский"
    L[LanguageMenu2_RU]="2. English"
    L[LanguageMenu2_EN]="2. English"
    ...
    L[Menu1_RU]="1. Поиск приложения и покупка (без загрузки)"
    L[Menu1_EN]="1. Search for app and purchase (without downloading)"
    L[Menu2_RU]="2. Поиск приложения и загрузка последней версии"
    L[Menu2_EN]="2. Search for app and download latest version"
    L[Menu3_RU]="3. Поиск приложения и загрузка (с выбором версии)"
    L[Menu3_EN]="3. Search for app and download (with version selection)"
    L[Menu4_RU]="4. Ввод ID приложений и покупка (без загрузки)"
    L[Menu4_EN]="4. Enter app IDs and purchase (without downloading)"
    L[Menu5_RU]="5. Ввод ID приложений и загрузка последней версии"
    L[Menu5_EN]="5. Enter app IDs and download latest version"
    L[Menu6_RU]="6. Ввод ID приложений и загрузка (с выбором версии)"
    L[Menu6_EN]="6. Enter app IDs and download (with version selection)"
    L[Menu7_RU]="7. Вывод списка приложений и покупка (без загрузки)"
    L[Menu7_EN]="7. Show list of apps and purchase (without downloading)"
    L[Menu8_RU]="8. Вывод списка приложений и загрузка последней версии"
    L[Menu8_EN]="8. Show list of apps and download latest version"
    L[Menu9_RU]="9. Вывод списка приложений и загрузка (с выбором версии)"
    L[Menu9_EN]="9. Show list of apps and download (with version selection)"
    L[Menu10_RU]="10. Проверка минимальной версии iOS для приложений в папке Apps"
    L[Menu10_EN]="10. Check minimum iOS version for apps in Apps folder"
    L[Menu11_RU]="11. Установка приложений из папки Apps"
    L[Menu11_EN]="11. Install apps from Apps folder"
    L[Menu12_RU]="12. Загрузить приложения из списка (последняя версия)"
    L[Menu12_EN]="12. Download apps from list (latest version)"
    L[Menu13_RU]="13. Загрузить приложения из списка (с выбором версии)"
    L[Menu13_EN]="13. Download apps from list (with version selection)"
    L[Menu14_RU]="14. Приобрести приложения из списка (без загрузки)"
    L[Menu14_EN]="14. Purchase apps from list (without downloading)"
    L[Menu15_RU]="15. Загрузить банковские приложения из списка (последняя версия)"
    L[Menu15_EN]="15. Download bank apps from list (latest version)"
    L[Menu16_RU]="16. Загрузить банковские приложения из списка (с выбором версии)"
    L[Menu16_EN]="16. Download bank apps from list (with version selection)"
    L[Menu17_RU]="17. Приобрести банковские приложения из списка (без загрузки)"
    L[Menu17_EN]="17. Purchase bank apps from list (without downloading)"
    L[Menu18_RU]="18. Очистка данных"
    L[Menu18_EN]="18. Clear data"
    L[Menu19_RU]="19. Выход из Apple ID + сброс настроек"
    L[Menu19_EN]="19. Log out of Apple ID + reset settings"
    L[Menu20_RU]="20. Поддержка проекта"
    L[Menu20_EN]="20. Project support"
    L[Menu21_RU]="21. Сменить язык (Change Language)"
    L[Menu21_EN]="21. Change Language (Сменить язык)"
    ...
    L[ModeMenu1_RU]="1. IPA_Downloader"
    L[ModeMenu1_EN]="1. IPA_Downloader"
    L[ModeMenu2_RU]="2. IPA_Installer"
    L[ModeMenu2_EN]="2. IPA_Installer"
    ...
    L[PurchasedListMenu1_RU]="1. Полный список приложений (GitHub)"
    L[PurchasedListMenu1_EN]="1. Full apps list (GitHub)"
    L[PurchasedListMenu2_RU]="2. Список приобретенных приложений"
    L[PurchasedListMenu2_EN]="2. Purchased apps list"
    L[PurchasedListMenu3_RU]="3. Список не приобретенных приложений"
    L[PurchasedListMenu3_EN]="3. Not purchased apps list"
    ...
    L[UpdateMenu1_RU]="1. Да"
    L[UpdateMenu1_EN]="1. Yes"
    L[UpdateMenu2_RU]="2. Нет"
    L[UpdateMenu2_EN]="2. No"
...
invoke_ipatool_version_prompt() {
    ...
    while true; do
        separator
        local choice
        choice=$(show_interactive_menu "$(t IpatoolVersionMenuTitle)" "" "1. $v2_label" "2. $v3_label")
        local selected_ver
        if [[ "$choice" == "2" ]]; then
            selected_ver="v3"
        else
